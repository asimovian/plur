 ...
 *
 * @constructor plur/error/Destroyed
 * @extends plur/error/Error
 **
 * @params {string} message
 * @params {=} data
 */
var DestroyedError = function(message, data) {
...
DestroyedError.prototype = PlurObject.create('plur/error/Destroyed', DestroyedError, PlurError);
